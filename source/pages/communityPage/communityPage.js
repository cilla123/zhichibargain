...
Page({
  ...
  showEllipsis : function(oldtext) {
    let that = this,
        ...
        eachline = (app.getSystemInfoData().windowWidth - 35) / 12 * 2,
        total_line_num = 5,
        has_line_num = 0,
        isellipsis = false;
  ...
  turnToDetail : function(event) {
    ...
    app.turnToPage('/pages/communityDetail/communityDetail?detail=' + id + '&articleStyle=' + article_style + '&dataLiked=' + dataLiked + '&phoneNumber=' + phoneNumber);
  },
  ...
  showCommentBox: function (event) {
    ...
    newData['sectionList[' + index + '].showCom'] = !this.data.sectionList[index].showCom;
  ...
  onShareAppMessage: function (res) {
    ...
    if (res.from === 'button') {
      ...
      let index = res.target.dataset.index,
          ...
          articlePath = '/pages/communityDetail/communityDetail?detail=' + id;
